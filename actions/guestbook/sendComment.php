...
if(isset($_POST['sendCom'])){
    ...
    if(!empty($_POST['name']) AND !empty($_POST['comment'])){
        ...
        $new = 'Il y a un nouveau message dans le livre d\'or sur votre portfolio.';
        $retour = mail('a.hamm@codeur.online', 'Nouveau message sur le livre d\'or', $new, 'From : portfolio');
